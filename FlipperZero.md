...
1. [[#Основы|Основы]]
	...
	3. [[#Основы#Прошивка (Firmware)|Прошивка (Firmware)]]
		1. [[#Прошивка (Firmware)#Возможные проблемы:|Возможные проблемы:]]
			1. [[#Возможные проблемы:#Internal storage is full|Internal storage is full]]
			2. [[#Возможные проблемы:#Восстановление из backup|Восстановление из backup]]
			3. [[#Возможные проблемы:#Firmware Recovery|Firmware Recovery]]
				1. [[#Firmware Recovery#Переключаемся в Recovery, если девайс работает но не обновляется|Переключаемся в Recovery, если девайс работает но не обновляется]]
				2. [[#Firmware Recovery#Переключаемся в Recovery, если девайс окирпичен:|Переключаемся в Recovery, если девайс окирпичен:]]
				3. [[#Firmware Recovery#Repair|Repair]]
	...
	5. [[#Основы#Функционал Тамагочи|Функционал Тамагочи]]
	6. [[#Основы#Питание|Питание]]
		1. [[#Питание#Выключение|Выключение]]
...
2. [[#Sub-GHz|Sub-GHz]]
	1. [[#Sub-GHz#Read sub-ghz|Read sub-ghz]]
		...
		2. [[#Read sub-ghz#Hopping (Переключение между частотами)|Hopping (Переключение между частотами)]]
	...
	6. [[#Sub-GHz#Sub-GHz Jammer|Sub-GHz Jammer]]
	7. [[#Sub-GHz#Sub-GHZ Playlist|Sub-GHZ Playlist]]
	8. [[#Sub-GHz#Антенны|Антенны]]
		1. [[#Антенны#Антенны для раций, а то там же тоже 433 (но не только)|Антенны для раций, а то там же тоже 433 (но не только)]]
		2. [[#Антенны#Штыри и телескопические антенны (вертикаль)|Штыри и телескопические антенны (вертикаль)]]
		3. [[#Антенны#И распиаренный диполь|И распиаренный диполь]]
		4. [[#Антенны#Яга (Уда-Яги)|Яга (Уда-Яги)]]
		5. [[#Антенны#Расстояния, длины, мощности и “рекорды”|Расстояния, длины, мощности и “рекорды”]]
		6. [[#Антенны#Результаты|Результаты]]
3. [[#125 kHz Rfid|125 kHz Rfid]]
...
8. [[#iButton|iButton]]
	...
	9. [[#iButton#Вездеходы|Вездеходы]]
		1. [[#Вездеходы#Словари для Fuzzer|Словари для Fuzzer]]
9. [[#Bad USB|Bad USB]]
	...
	4. [[#Bad USB#Что должен уметь BadUSB?|Что должен уметь BadUSB?]]
10. [[#U2F|U2F]]
...
11. [[#Apps|Apps]]
	...
	2. [[#Apps#Games|Games]]
	3. [[#Apps#GPIO|GPIO]]
		1. [[#GPIO#Atari SIO Emulator|Atari SIO Emulator]]
		2. [[#GPIO#401/DigiLab|401/DigiLab]]
		3. [[#GPIO#Lab401/Light Messenger|Lab401/Light Messenger]]
		4. [[#GPIO#BMI Air Mouse|BMI Air Mouse]]
		5. [[#GPIO#[PMSx003] Airmon|[PMSx003] Airmon]]
		6. [[#GPIO#AVR Flasher|AVR Flasher]]
			1. [[#AVR Flasher#Wiring|Wiring]]
			2. [[#AVR Flasher#Supported Microcontrollers|Supported Microcontrollers]]
		7. [[#GPIO#BarCode ScannerE|BarCode ScannerE]]
		8. [[#GPIO#\[ESP32\] Camera Suite|[ESP32] Camera Suite]]
		9. [[#GPIO#Coffee-EEPROM-FAP|Coffee-EEPROM-FAP]]
		10. [[#GPIO#CAN-FD-HS|CAN-FD-HS]]
		11. [[#GPIO#RC2014 ColecoVision|RC2014 ColecoVision]]
		12. [[#GPIO#DAP Link|DAP Link]]
		13. [[#GPIO#\[ESP32\] WiFi Marauder|[ESP32] WiFi Marauder]]
		14. [[#GPIO#ESP8266 Deauther|ESP8266 Deauther]]
		15. [[#GPIO#esp8266_deauther v2|esp8266_deauther v2]]
		16. [[#GPIO#IFTTT Virtual Button|IFTTT Virtual Button]]
		17. [[#GPIO#ESP Flasher|ESP Flasher]]
		18. [[#GPIO#\[W5500\] Ethernet|[W5500] Ethernet]]
		19. [[#GPIO#Evil captive portal|Evil captive portal]]
		20. [[#GPIO#\[ESP32\] Evil portal|[ESP32] Evil portal]]
		21. [[#GPIO#Flashlight|Flashlight]]
		22. [[#GPIO#FlipTDI|FlipTDI]]
		23. [[#GPIO#FlipRPI|FlipRPI]]
		24. [[#GPIO#Flipagotchi|Flipagotchi]]
		25. [[#GPIO#\[J305\]Atomic Dice Roller|[J305]Atomic Dice Roller]]
		26. [[#GPIO#\[J305\] geiger counter|[J305] geiger counter]]
		27. [[#GPIO#SPI-Terminal|SPI-Terminal]]
		28. [[#GPIO#Scope (flipperscope)|Scope (flipperscope)]]
		29. [[#GPIO#\[TEA5767\] FM Radio|[TEA5767] FM Radio]]
		30. [[#GPIO#\[ESP32\] Ghost ESP|[ESP32] Ghost ESP]]
		31. [[#GPIO#7-Segment Output|7-Segment Output]]
		32. [[#GPIO#GPIO Controller|GPIO Controller]]
		33. [[#GPIO#GPIO Reader 2|GPIO Reader 2]]
		34. [[#GPIO#Sentry Safe|Sentry Safe]]
		35. [[#GPIO#Timelapse|Timelapse]]
		36. [[#GPIO#\[NMEA\] GPS|[NMEA] GPS]]
		37. [[#GPIO#\[HC-SR\] Dist. sensor|[HC-SR] Dist. sensor]]
		38. [[#GPIO#i2c Tools|i2c Tools]]
		39. [[#GPIO#INA Meter|INA Meter]]
			1. [[#INA Meter#Supported Sensors:|Supported Sensors:]]
			2. [[#INA Meter#Wiring|Wiring]]
		40. [[#GPIO#Lightmeter|Lightmeter]]
		...
		41. [[#GPIO#Logic analyzer|Logic analyzer]]
		42. [[#GPIO#Longwave Clock|Longwave Clock]]
		43. [[#GPIO#LORA Terminal|LORA Terminal]]
		44. [[#GPIO#Magspoof|Magspoof]]
		45. [[#GPIO#\[Mx2125\] Accelerometer|[Mx2125] Accelerometer]]
		46. [[#GPIO#\[MH-Z19\] CO2 sensor|[MH-Z19] CO2 sensor]]
		47. [[#GPIO#CO2 Logger|CO2 Logger]]
		48. [[#GPIO#NRF24|NRF24]]
		49. [[#GPIO#Pokemon Trade Tool|Pokemon Trade Tool]]
		50. [[#GPIO#RadSens (Radiation Sensor)|RadSens (Radiation Sensor)]]
		51. [[#GPIO#RCWL-516 Motion Sensor|RCWL-516 Motion Sensor]]
		52. [[#GPIO#SD SPI|SD SPI]]
			1. [[#SD SPI#Pinout|Pinout]]
			2. [[#SD SPI#Force Unlock|Force Unlock]]
		53. [[#GPIO#ServoTester и ServoTester 2|ServoTester и ServoTester 2]]
		54. [[#GPIO#Signal Generator|Signal Generator]]
			1. [[#Signal Generator#PWM Mode|PWM Mode]]
			2. [[#Signal Generator#Clock Mode|Clock Mode]]
		55. [[#GPIO#Simultaneous UHF RFID Reader|Simultaneous UHF RFID Reader]]
		56. [[#GPIO#SPI Mem Manager|SPI Mem Manager]]
		57. [[#GPIO#\[Mx2125\] Step Counter|[Mx2125] Step Counter]]
		58. [[#GPIO#SWD Probe|SWD Probe]]
		59. [[#GPIO#UART Terminal|UART Terminal]]
			1. [[#UART Terminal#Connecting|Connecting]]
		60. [[#GPIO#u-blox GPS|u-blox GPS]]
		61. [[#GPIO#Temp sensors reader|Temp sensors reader]]
			1. [[#Temp sensors reader#List of supported sensors|List of supported sensors]]
		62. [[#GPIO#\[USPING\] Distance Sensor|[USPING] Distance Sensor]]
		63. [[#GPIO#UV Meter|UV Meter]]
		64. [[#GPIO#WHC SWIO Flasher|WHC SWIO Flasher]]
		65. [[#GPIO#Wiegand Reader|Wiegand Reader]]
		66. [[#GPIO#WiFi Mapping|WiFi Mapping]]
		67. [[#GPIO#\[WiFi\] Scanner|[WiFi] Scanner]]
		68. [[#GPIO#Wii EC Analyzer|Wii EC Analyzer]]
		69. [[#GPIO#\[GPIO\] Wire Tester|[GPIO] Wire Tester]]
		70. [[#GPIO#\[WS2812B\] LED Tester|[WS2812B] LED Tester]]
	4. [[#Apps#Infrared|Infrared]]
		1. [[#Infrared#Flame RNG|Flame RNG]]
		2. [[#Infrared#XRemote|XRemote]]
			1. [[#XRemote#Idea|Idea]]
			2. [[#XRemote#Learn new remote|Learn new remote]]
			3. [[#XRemote#Custom Layout|Custom Layout]]
			4. [[#XRemote#Standard file support|Standard file support]]
			5. [[#XRemote#Button schema|Button schema]]
			6. [[#XRemote#Alternative button names|Alternative button names]]
			7. [[#XRemote#Default alternative names|Default alternative names]]
		3. [[#Infrared#Intervalometer|Intervalometer]]
		4. [[#Infrared#IR Scope|IR Scope]]
		5. [[#Infrared#LIDAR Emulator|LIDAR Emulator]]
		6. [[#Infrared#Xbox Controller|Xbox Controller]]
	5. [[#Apps#Media|Media]]
		1. [[#Media#BPM Tapper|BPM Tapper]]
		2. [[#Media#Flipper Keyller|Flipper Keyller]]
		3. [[#Media#Metronome|Metronome]]
		4. [[#Media#Morse Code|Morse Code]]
		5. [[#Media#Flizzer Tracker|Flizzer Tracker]]
		6. [[#Media#Music Player|Music Player]]
		7. [[#Media#Ocarina|Ocarina]]
		8. [[#Media#Text to SAM|Text to SAM]]
		9. [[#Media#Tuning Fork|Tuning Fork]]
		10. [[#Media#USB-MIDI|USB-MIDI]]
		11. [[#Media#Video Player|Video Player]]
	6. [[#Apps#NFC|NFC]]
		1. [[#NFC#Metroflip|Metroflip]]
			1. [[#Metroflip#Supported Cards|Supported Cards]]
		2. [[#NFC#MIFARE Classic Editor|MIFARE Classic Editor]]
		3. [[#NFC#MFKey|MFKey]]
		4. [[#NFC#Mifare Fuzzer|Mifare Fuzzer]]
		5. [[#NFC#NFC APDU Runner|NFC APDU Runner]]
			1. [[#NFC APDU Runner#Features|Features]]
		6. [[#NFC#NFC-Eink|NFC-Eink]]
		7. [[#NFC#Nfc Magic|Nfc Magic]]
		8. [[#NFC#NFC Maker|NFC Maker]]
		9. [[#NFC#NFC Playlist|NFC Playlist]]
		10. [[#NFC#Passport Reader|Passport Reader]]
		11. [[#NFC#PicoPass (HID iClass)|PicoPass (HID iClass)]]
		12. [[#NFC#Seader|Seader]]
		13. [[#NFC#Seos compatible|Seos compatible]]
		14. [[#NFC#VB Migration Assistant|VB Migration Assistant]]
		15. [[#NFC#Weebo|Weebo]]
		16. [[#NFC#UDECard|UDECard]]
	7. [[#Apps#RFID|RFID]]
		1. [[#RFID#RFID Beacon|RFID Beacon]]
		2. [[#RFID#RFID Fuzzer|RFID Fuzzer]]
		3. [[#RFID#EM4100 Key generator|EM4100 Key generator]]
		4. [[#RFID#T5577 Multiwriter|T5577 Multiwriter]]
		5. [[#RFID#T5577 Raw Writer|T5577 Raw Writer]]
	8. [[#Apps#Scripts|Scripts]]
	9. [[#Apps#Sub-Ghz|Sub-Ghz]]
		1. [[#Sub-Ghz#Enhanced Sub-Ghz Chat|Enhanced Sub-Ghz Chat]]
		2. [[#Sub-Ghz#Flipper Share|Flipper Share]]
		3. [[#Sub-Ghz#Music to Sub-GHz Radio|Music to Sub-GHz Radio]]
		4. [[#Sub-Ghz#Genie Door Recorder|Genie Door Recorder]]
		5. [[#Sub-Ghz#HC-11 modem|HC-11 modem]]
		6. [[#Sub-Ghz#Restaurant Pager Trigger|Restaurant Pager Trigger]]
		7. [[#Sub-Ghz#POCSAG Pager|POCSAG Pager]]
		8. [[#Sub-Ghz#ProtoView|ProtoView]]
		9. [[#Sub-Ghz#Radio Scanner|Radio Scanner]]
		10. [[#Sub-Ghz#Rolling Flaws|Rolling Flaws]]
		11. [[#Sub-Ghz#ShapShup|ShapShup]]
		12. [[#Sub-Ghz#Sub-GHz bruteforcer|Sub-GHz bruteforcer]]
		13. [[#Sub-Ghz#Sub-GHz Remote|Sub-GHz Remote]]
		14. [[#Sub-Ghz#Sub-GHz Scheduler|Sub-GHz Scheduler]]
		15. [[#Sub-Ghz#TPMS Reader|TPMS Reader]]
		16. [[#Sub-Ghz#Weather Station|Weather Station]]
	10. [[#Apps#Tools|Tools]]
		1. [[#Tools#Analog Clock|Analog Clock]]
		2. [[#Tools#Barcode App|Barcode App]]
		3. [[#Tools#Brainfuck|Brainfuck]]
		4. [[#Tools#Caesar Cipher|Caesar Cipher]]
		5. [[#Tools#Calculator|Calculator]]
		6. [[#Tools#DCF77 Transmitter|DCF77 Transmitter]]
		7. [[#Tools#DCF77 Clock Spoof|DCF77 Clock Spoof]]
		8. [[#Tools#DTMF Dolphin|DTMF Dolphin]]
		9. [[#Tools#FlipBIP Crypto Wallet|FlipBIP Crypto Wallet]]
		10. [[#Tools#Ford Radio Codes|Ford Radio Codes]]
		11. [[#Tools#HEX Editor|HEX Editor]]
		12. [[#Tools#HEX Viewer|HEX Viewer]]
		13. [[#Tools#Key Copier|Key Copier]]
		14. [[#Tools#RFID detector|RFID detector]]
		15. [[#Tools#NickName Generator|NickName Generator]]
		16. [[#Tools#Nightstand Clock|Nightstand Clock]]
		17. [[#Tools#Programmer Calculator|Programmer Calculator]]
		18. [[#Tools#QR Code|QR Code]]
		19. [[#Tools#Quac!|Quac!]]
		20. [[#Tools#Resistance calculator|Resistance calculator]]
		21. [[#Tools#SD Info|SD Info]]
		22. [[#Tools#Authenticator|Authenticator]]
		23. [[#Tools#uPython|uPython]]
		24. [[#Tools#VIN decoder|VIN decoder]]
	11. [[#Apps#USB|USB]]
		1. [[#USB#USB Keyboard & Mouse (USB Remote)|USB Keyboard & Mouse (USB Remote)]]
		2. [[#USB#HID File Transfer|HID File Transfer]]
		3. [[#USB#Mass Storage|Mass Storage]]
		4. [[#USB#USB Consumer Control|USB Consumer Control]]
		5. [[#USB#USB HID Autofire|USB HID Autofire]]
		6. [[#USB#USB Game Controller|USB Game Controller]]
12. [[#Flipper Mobile App|Flipper Mobile App]]
	1. [[#Flipper Mobile App#Подключение телефона к Flipper Zero|Подключение телефона к Flipper Zero]]
		1. [[#Подключение телефона к Flipper Zero#Если флиппер не обнаруживается:|Если флиппер не обнаруживается:]]
		2. [[#Подключение телефона к Flipper Zero#If Flipper Mobile App fails to synchronize with your Flipper Zero|If Flipper Mobile App fails to synchronize with your Flipper Zero]]
	2. [[#Flipper Mobile App#Flipper Mobile App: overview|Flipper Mobile App: overview]]
	3. [[#Flipper Mobile App#Обновление прошивки в мобильном приложении|Обновление прошивки в мобильном приложении]]
13. [[#qFlipper|qFlipper]]
...
14. [[#Разработка|Разработка]]
	1. [[#Разработка#Hello World|Hello World]]
		1. [[#Hello World#Очередь сообщений|Очередь сообщений]]
		2. [[#Hello World#Графический интерфейс|Графический интерфейс]]
		3. [[#Hello World#Таймер|Таймер]]
		4. [[#Hello World#Кастомные события|Кастомные события]]
		5. [[#Hello World#Мигание светодиодом|Мигание светодиодом]]
15. [[#Video Game Module|Video Game Module]]
...
![[controls.webp]]
*Обозначение кнопок далее по тексту*
...
```ad-warning
Не пытайтесь экспериментировать со своим автомобилем. В большинстве современных решений (где-то с 2000 года) используются rolling коды и блокировка при рассинхроне.
Вы можете просто заблокировать штатные ключи.

Тем не менее до сих пор встречаются машины без должной защиты.
В качестве примера см. **CVE-2022-27254** для Honda Civic LX, EX, EX-L, Touring, Si и Type R, выпущенныx в период с 2016 по 2020 год
```
...
#### Frequency Analyzer
Помогает определить частоту сигнала
**Main Menu** **-> Sub-GHz -> Frequency Analyzer**.

![[subghz_freq_an.webp]]

### Hopping (Переключение между частотами)
Для приема сигнала на неизвестной частоте можно использовать режим hopping. В этом режиме Flipper Zero быстро переключается между доступными частотами и измеряет уровень сигнала. Как только уровень сигнала превысит -90 дБм, переключение прекращается, и Flipper Zero принимает сигнал на этой частоте в течение одной секунды, затем переключение между частотами возобновляется. Для поиска сигналов в режиме скачкообразной перестройки в меню конфигурации установите переключатель в положение ON.

В последних прошивках вместо ON будет пролистываться желаемый уровень RSSI от -90dBm до -40dBm
...
Так же см. приложение [[#Radio Scanner]]
...
## Антенны
Простейшая антенна для определенной длины волны — это вибратор длиной в четверть этой самой волны. Такой антенной может стать кусок проволоки или даже гвоздь. Для 433MHz четверть — это 173мм, так что можно взять гвоздь-на-200, отрезать от него 27мм и у вас будет антенна-штырь на ±433MHz, и она будет даже сносно работать.

Кроме штырей есть ещё  диполи, J-Антенны, Яги, и тысячи других.

![[antena.png]]

C [[#External Radio Module for 433 MHz aka CC1101]] модулями приходит антенна длинной всего пару сантиметров (главное не длина, а точность и хорошая работа). Здесь эффективность антенны принесена в жертву её габаритам. В целом если посмотреть, то это самая компромиссная антенна, которая “просто работает” и не самая большая по размеру, что позволяет ее переносить в кармане.

![[antena_graf.png]]

На рисунке показан график КСВ (коэффициента стоячей волны) антенны  в зависимости от частоты. Не будем углубляться в подробности, но чем он меньше, тем меньше энергии отражается обратно к передатчику и тем лучше. Идеальный показатель — 1, меньше не будет. КСВ не показывает, насколько хорошо антенна излучает (резистор в 50 Ом в данном случае покажет отличный результат на всём диапазоне вообще, хотя и ничего излучать не будет), а без правильного  согласования антенны и передатчика хорошо излучать ничего точно не будет. Так что для начала нам надо добиться наименьшего возможного КСВ на нужных нам частотах. 

Тут ярко-зеленым — показатели настроенной антенна, а приглушенным зеленым — не настроенной. 

Как видим, на настроенной, даже такой маленькой, антенне мы получили очень даже хороший показатель 1.24 КСВ. Неплохая заявка.

### Антенны для раций, а то там же тоже 433 (но не только)

![[antena_walkie.jpeg]]
*Слева Baofeng, справа MIDLAND*

Антенны на рациях настроены на другие диапазоны. Например, всеми любимый Baofeng UV-5R работает в двух диапазонах VHF (136-174 МГц) и UHF (400-520 МГц). А “убийца баофенга” Quansheng UV-K5 работает на прием и передачу в VHF 136-174 / UHF 400-480 МГц, и только на прием: 50-76, 108-136 (АМ), 174-350, 350-400, 470-600 МГц. Как видите, тут история такая же как и со встроенной антенной флиппера, которая должна работать компромиссно.

![[antena_walkie_graf.png]]

Ярко-зеленая — Baofeng , приглушенно зеленая — MIDLAND . Важно отметить, что у баофенга антенна двухдиапазонная, она еще и на двухметровый диапазон работает. Обе они широкополосные и на всем интересующем нас диапазоне КСВ больше 3 не понимается.

Тоже вполне неплохо, хотя нам такая широкая полоса как-бы и ни к чему.

![[nagoia.jpeg]]


Про нагою ходят легенды, но на самом деле для гражданского сегмента она не сильно-то и нужна, а по факту она только длиннее и немного неудобнее.

![[nagoia_graf.png]]

Ну такое, согласование похуже, чем у штатной резинки даже (она приглушенно зеленая). Тут конечно дело ещё в том, что на 144МГц она себя ведёт получше, но это сейчас вне поля наших интересов.

### Штыри и телескопические антенны (вертикаль)

![[antena_vert.jpeg]]
*Телескоп, длинная и DBTV*

Такие штыри и телескопы можно купить на али, или поискать где-то телескопическую часть от старого телевизора, выдрать её из ненужного приёмника, ну, короче, как-то найти/купить.

![[antena_vert_graf.png]]

Регулярный паттерн - это влияние кабеля, его можно не учитывать (откалибровать измерительный прибор на такую антенну не вышло - некуда подсоединять эталоны на конце кабеля, сорян).

Как видим, согласование более чем неплохое, 1.34. Да и полоса достаточно широкая, пару мегагерц вверх будет точно не хуже (хотя тоже, зачем? Почти всё что нам нужно на 433.92).

Про антенну DBTV и говорить особо нечего, согласование плохое, хорошей эффективности не стоит ждать точно.

### И распиаренный диполь

![[antena_dipol.jpeg]]

Все его хвалят и рекомендуют, но чего-то супер-крутого от него мы не смогли получить, кроме большей направленности, чем у предыдущих антенн.

![[antena_dipol_graf.png]]

3.23???? Такое. На 460+ МГц он себя явно лучше покажет, но это далеко от интересной всем частоты. Лучшая направленность, конечно, скажется в положительную сторону.

Возможно конкретно наш экземпляр оказался коротковат, и если приделать ему усы длиннее, то будет другой разговор, но имеем, что имеем.
...
В измерениях участвуют 2 антенны, одна ярким зеленым, вторая приглушенно зеленым. Обе не хуже 1.56 согласованы, очень неплохой результат (для второй антенны вообще с первого раза попадание, ничего не пришлось подстраивать).

### Расстояния, длины, мощности и “рекорды”

Куда же без рекордов. Пробовали мы чатицца на стандартные пипирки, но они больше 50 метров связь уже не давали. Может ещё дело в шумной городской среде, но тем не менее, 50 метров — мало, хочется дальше!

Мы возьмем направленную антенну Яга (Уда-Яги) и на ней остановимся поподробнее. Как говорили в прошлой статье, людям хочется “быстрее, выше, сильнее — вместе” поэтому мы пойдем мерить насколько далеко мы сможем передать информацию флиппером с внешним модулем без усилителя.

Первый рубеж для нас был почти 4 км. И знаете, на этом можно было бы и остановиться, потому что “да кому надо ворота на 4 км открывать?”, но нас такой уверенный результат на 10 mW на 4 км не остановил.

Дальше уже было 9 км

Ну и ещё мы сделали замер уже на 12 км, пришлось поехать за город на дачу.

Дальше уже не стали мерить, потому что кому в здравом уме придет мысль открывать шлагбаум через 12 км прямой видимости

### Результаты

Ну и ещё немного лабораторных результатов, которые объяснят, почему же на простой пипирке получается всего 50 метров (Виктор quen0n делал замеры с двумя пипирками и внешними модулями и получил 150 метров уверенного приема-передачи), а на направленной Уда-Яги вышло на 2 порядка больше.

Согласование антенны — это одно дело, а эффективность её излучения — дело немного другое. Если антенна плохо согласована, то часть энергии просто отразится обратно в передатчик, и даже потенциально не сможет быть излучена и поработать во благо (а может и спалить передатчик, если он к такому не готов). Но даже если ничего назад не отражается, то антенна может просто превратить её в тепло (и сколько-то неизбежно превратит, резистор например хорошо согласуется, но всё просто превращает в тепло, нам такое явно не надо).

Так вот, эффективность антенны мы замерим приёмником, излучая с некоторого расстояния, и проверяя уровень сигнала на нём. Данные, конечно ,получатся относительными, но это даёт неплохое представление о том, что и насколько эффективно работает.

Как видно, все ненаправленные антенны дают ± одинаковые показатели: те, что похуже согласованы, похуже и работают, та, что получше — даёт результат получше, но не радикально. И только направленная Уда-Яги резко вырывается вперед, аж на 15dB от среднего. А это раз в 30 с небольшим.

То есть при той же мощности передатчика мы неплохо так сконцентрировали энергию в одну сторону. И так же усилили приём с одной стороны, ослабив все помехи с других направлений.

Так что прям магии не произошло, на Луне нас всё равно не услышат, но вот значительное улучшение — налицо. Расплатились за это габаритами, к сожалению, по-другому не получается никак. Но тут сам факт такой дальней связи такой малой мощностью делает на душе приятно.

|                                                                                         |                                  |                                                                          |
| --------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------ |
| **Антенна**                                                                             | **Мощность**                     | **Коммент**                                                              |
| Пипирка                                                                                 | -65dB                            | Для 95% задач норм.                                                      |
| Baofeng антенна                                                                         | -64dB                            | Лучше пипирки, но не значительно.                                        |
| Midland антенна                                                                         | -61dB                            | Чуть лучше баофенга.                                                     |
| DBTV  антенна                                                                           | -70dB                            | Вам точно не надо такого.                                                |
| Длинная                                                                                 | -68dB                            | "Сомнительно, но окэй", хотя тоже не нужно. А из плюсов только магнитик. |
| Телескоп собранный и разобранный                                                        | -64dB (да, получилось одинаково) | Имеет право на жизнь, но не оч удобно и хлипко.                          |
| Диполь (Китайцы обещали в 443, но пришел не тот. Результат мог и должен был быть лучше) | -67dB                            | Имеет место быть, будет лучше пипирки и штыря из-за направленности.      |
|Яга (Уда-Яги)|-50dB|BFG большая-точная-направленная, но не всем можно ;)|

Источник: https://habr.com/ru/articles/801801/
...
## Что должен уметь BadUSB?

В тематических репозиториях 99% скриптов - бред собачий. От почти обязательной папки prank, до скрипткидисовых кейлогеров сливающих в Discord.

Давайте на секунду прикинем специфику. Вот компьютер вероятного противника, он разлочен (чего не должно быть), видеокамер нет (ну допустим), хозяина рядом нет (что тоже странно) и на нем админские права (чудо чудное).
У Вас есть условных 15 секунд воткнуть RubberDucky\FlipperZero и получить результат.
Вот тут начинается странное. Большинство payload'ов начинают качать ps1 скрипты из сети. Или сборки mimikatz. Или реверс шелы для metasploit. Или еще что. Поэтому перед этим придется как минимум отрубать Defender.
Много всплывающих окон, трафика и вообще характерного шума для безопасников. При том что вы вот прямо тут. При чем всё это работает только если есть интернет.
Но если у нас есть интернет и 15 секунд, то логичнее бы было залить с2-агента. Ну или хотя бы ПО для удаленного доступа.

Вариант два: Вы хотите выдернуть инфу вот прямо сейчас. Тогда не стоит связываться с сетевой загрузкой вообще. Можно залить бинарники прямо через BadUSB, например с помощью base64, см. badusb/Windows/base64file_write_to_disk (правда размер файла должен быть весьма скромным)
...
For hackertyper, fake matrix, vscode, word, etc. go to https://geektyper.com/

Ну и последний вид использования: "GoodUSB".
Автоматизация работы эникейщика-админа. Вот тут уже можно и полезную нагрузку из интернета, и результаты в чатик.

+- стандартные примеры см. в папке badusb
...
**Wiegand** — простой проводной интерфейс связи между устройством чтения идентификатора (карточки) и контроллером, широко применяемый в системах контроля и управления доступом.
...
Интерфейс не поддерживает шифрование передаваемых данных, аутентификацию сторон, контроль целостности линии между считывателем и контроллером. Также интерфейс не позволяет решать других задач взаимодействия считывателя с контроллером кроме передачи результата идентификации, в т. ч. управление индикацией считывателей. 
...
Intervalometer for Canon, Nikon, and Sony cameras. Uses IR shutter release.
...
Чтобы запустить скрипт на Flipper Zero, достаточно добавить файл с расширением JS в папку SD Card/apps/Scripts (через qFlipper или Flipper Lab) и запустить его из меню **Apps** —> **Scripts**. 
...
Разработка под Flipper Zero: быстрый старт и первое приложение https://habr.com/ru/articles/594895/
Пишем и отлаживаем приложения для Flipper Zero https://habr.com/ru/articles/710700/
Пишем UART-терминал для Flipper zero https://habr.com/ru/companies/sportmaster_lab/articles/721000/
NFC-крокодил: продвинутая разработка под Flipper Zero https://habr.com/ru/companies/selectel/articles/742438/
APRS. AFSK модулятор из Flipper Zero https://habr.com/ru/articles/742428/
Как и почему я писал для Флиппера на Си-с-классами https://habr.com/ru/companies/ruvds/articles/768658/
...
1. Собрать вместе с прошивкой:
   Положить каталог с приложением в директорию application_user репозитория [flipperdevices/flipperzero-firmware](https://github.com/flipperdevices/flipperzero-firmware/) и компилировать с помощью утилиты fbt.
   В папке dist получите файл прошивки *flipper-z-{target}-update-{suffix}.tgz* которым надо будет прошить флиппер.
   ```bash
...
2. Собирать приложение отдельно утилитой [ufbt](https://github.com/flipperdevices/flipperzero-ufbt).
   ```bash
...
***Далее приводится слегка исправленная статья https://yakovlev.me/hello-flipper-zero/
...
- 
По соглашениям Flipper Zero точкой входа является функция, которая будет называться как наше приложение + суффикс _`app`. Традиционно для C функция будет возвращать код ошибки (0 — все круто), а принимать некоторые данные по указателю. Данные нам не потребуются, так что код с инклудом для_ `int32_t` будет выглядеть так:
...
В папке `dist` теперь лежит наш FAP-файл, который можно любым удобным вам способом закинуть на Flipper в папку SD Card/apps/. 

Запуск приложения не будет приводить ни к каким ошибкам, функция честно исполнится, и приложение тут же завершится.
...
Для того, чтоб использовать такой функционал нам уже не обойтись одним только `stdio.h`, а потребуется начать использовать заголовки из SDK Flipper. Называется она `FURI`, где-то читал, что расшифровывается это как `Flipper Universal Registry Implementation`. Кажется, суть уже ушла далеко от названия, но аббревеатура классная, так что её оставили. Помимо нее сразу подключим еще несколько заголовков:
...
мы получили "Hello World!" на экране (кажется, стоило сделать отступ слева не нулевым), так еще и кнопка "назад" закрывает приложение!
