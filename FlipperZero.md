TODO
Поиск на github и youtube
https://flipper.wiki/
https://github.com/djsime1/awesome-flipperzero

- [[#Включение|Включение]]
- [[#Карта microSD|Карта microSD]]
	- [[#Карта microSD#Flipper не видит карту|Flipper не видит карту]]
	- [[#Карта microSD#Безопасное извлечение|Безопасное извлечение]]
- [[#Прошивка (Firmware)|Прошивка (Firmware)]]
	- [[#Прошивка (Firmware)#Mobile App|Mobile App]]
		- [[#Mobile App#Подключение телефона к Flipper Zero|Подключение телефона к Flipper Zero]]
			- [[#Подключение телефона к Flipper Zero#Если флиппер не обнаруживается:|Если флиппер не обнаруживается:]]
		- [[#Mobile App#Обновление прошивки в мобильном приложении|Обновление прошивки в мобильном приложении]]
	- [[#Прошивка (Firmware)#Обновление через qFlipper|Обновление через qFlipper]]
	- [[#Прошивка (Firmware)#Internal storage is full|Internal storage is full]]
		- [[#Internal storage is full#через Settings|через Settings]]
		- [[#Internal storage is full#через qFlipper|через qFlipper]]
		- [[#Internal storage is full#Восстановление из backup|Восстановление из backup]]
	- [[#Прошивка (Firmware)#Firmware Recovery|Firmware Recovery]]
		- [[#Firmware Recovery#Переключаемся в Recovery|Переключаемся в Recovery]]
			- [[#Переключаемся в Recovery#Если девайс работает но не обновляется|Если девайс работает но не обновляется]]
			- [[#Переключаемся в Recovery#Если девайс окирпичен:|Если девайс окирпичен:]]
		- [[#Firmware Recovery#Repair|Repair]]
- [[#Основной экран (Desktop)|Основной экран (Desktop)]]
	- [[#Основной экран (Desktop)#Status bar|Status bar]]
	- [[#Основной экран (Desktop)#Навигация|Навигация]]
	- [[#Основной экран (Desktop)#Главное меню|Главное меню]]
	- [[#Основной экран (Desktop)#Меню блокировки|Меню блокировки]]
		- [[#Меню блокировки#Lock|Lock]]
		- [[#Меню блокировки#Mute|Mute]]
		- [[#Меню блокировки#Dummy Mode|Dummy Mode]]
	- [[#Основной экран (Desktop)#Passport|Passport]]
	- [[#Основной экран (Desktop)#Archive|Archive]]
	- [[#Основной экран (Desktop)#Device Info|Device Info]]
	- [[#Основной экран (Desktop)#Quick Access Apps|Quick Access Apps]]
- [[#Тамагочи|Тамагочи]]
- [[#Питание|Питание]]
	- [[#Питание#Выключение питания:|Выключение питания:]]
	- [[#Питание#Sleep mode|Sleep mode]]
- [[#Перезагрузка|Перезагрузка]]
- [[#Settings (Настройки)|Settings (Настройки)]]
	- [[#Settings (Настройки)#Bluetooth|Bluetooth]]
	- [[#Settings (Настройки)#LCD and Notifications|LCD and Notifications]]
	- [[#Settings (Настройки)#Storage|Storage]]
	- [[#Settings (Настройки)#MicroSD card benchmark|MicroSD card benchmark]]
	- [[#Settings (Настройки)#Power|Power]]
	- [[#Settings (Настройки)#Desktop settings|Desktop settings]]
	- [[#Settings (Настройки)#System settings|System settings]]
		- [[#System settings#Logs|Logs]]
		- [[#System settings#Log Device|Log Device]]
		- [[#System settings#Debug Mode|Debug Mode]]
		- [[#System settings#Heap Trace|Heap Trace]]
	- [[#Settings (Настройки)#Expansion Modules|Expansion Modules]]
	- [[#Settings (Настройки)#Clock & Alarm|Clock & Alarm]]
	- [[#Settings (Настройки)#About|About]]
- [[#Read sub-ghz|Read sub-ghz]]
	- [[#Read sub-ghz#Настройка частоты|Настройка частоты]]
		- [[#Настройка частоты#Frequency Analyzer|Frequency Analyzer]]
	- [[#Read sub-ghz#Hopping|Hopping]]
	- [[#Read sub-ghz#Bin_RAW|Bin_RAW]]
	- [[#Read sub-ghz#Прослушивание раций|Прослушивание раций]]
- [[#Read RAW sub-ghz|Read RAW sub-ghz]]
- [[#Ручное добавление|Ручное добавление]]
- [[#Поддерживаемые протоколы|Поддерживаемые протоколы]]
- [[#Tesla|Tesla]]
- [[#Антенны|Антенны]]
- [[#Какие бывают RFID-метки|Какие бывают RFID-метки]]
- [[#Отличия RFID 125 кГц и 13.56 МГц|Отличия RFID 125 кГц и 13.56 МГц]]
- [[#Низкочастотные протоколы 125 кГц|Низкочастотные протоколы 125 кГц]]
	- [[#Низкочастотные протоколы 125 кГц#HID Prox|HID Prox]]
	- [[#Низкочастотные протоколы 125 кГц#Indala|Indala]]
- [[#Ввод ID карты вручную|Ввод ID карты вручную]]
- [[#Запись болванки 125 кГц|Запись болванки 125 кГц]]
- [[#Чипы в котах и собаках|Чипы в котах и собаках]]
	- [[#Чипы в котах и собаках#Animal RFID microchips supported|Animal RFID microchips supported]]
	- [[#Чипы в котах и собаках#Метод 1.  Нащупать самому|Метод 1.  Нащупать самому]]
	- [[#Чипы в котах и собаках#Метод 2. Поиск флипером|Метод 2. Поиск флипером]]
- [[#Высокочастотные карты 13,56 МГц|Высокочастотные карты 13,56 МГц]]
- [[#Различие чтения UID и данных внутри карты|Различие чтения UID и данных внутри карты]]
- [[#NFC cards type A|NFC cards type A]]
	- [[#NFC cards type A#MIFARE Classic|MIFARE Classic]]
	- [[#NFC cards type A#Mifare Ultralight и NTAG|Mifare Ultralight и NTAG]]
	- [[#NFC cards type A#MIFARE® DESFire|MIFARE® DESFire]]
	- [[#NFC cards type A#Подорожник|Подорожник]]
		- [[#Подорожник#Анализ памяти карты|Анализ памяти карты]]
		- [[#Подорожник#Атака повторного воспроизведения|Атака повторного воспроизведения]]
		- [[#Подорожник#Мобильное приложение Plantain|Мобильное приложение Plantain]]
- [[#NFC cards type V|NFC cards type V]]
	- [[#NFC cards type V#ICODE® SLIX|ICODE® SLIX]]
- [[#NFC cards type F|NFC cards type F]]
	- [[#NFC cards type F#FeliCa™ Lite-S|FeliCa™ Lite-S]]
- [[#NFC cards type B|NFC cards type B]]
	- [[#NFC cards type B#ST25TB|ST25TB]]
- [[#Банковские карты EMV (PayPass, Apple Pay)|Банковские карты EMV (PayPass, Apple Pay)]]
	- [[#Банковские карты EMV (PayPass, Apple Pay)#Виртуальная карта ApplePay VS Физическая банковская карта|Виртуальная карта ApplePay VS Физическая банковская карта]]
	- [[#Банковские карты EMV (PayPass, Apple Pay)#Как украсть деньги с бесконтактной карты и Apple Pay|Как украсть деньги с бесконтактной карты и Apple Pay]]
- [[#MFKey32 attack|MFKey32 attack]]
	- [[#MFKey32 attack#Troubleshooting|Troubleshooting]]
- [[#Unlocking cards with passwords|Unlocking cards with passwords]]
	- [[#Unlocking cards with passwords#Генерация пароля|Генерация пароля]]
	- [[#Unlocking cards with passwords#Ручной ввод пароля|Ручной ввод пароля]]
- [[#Запись NFC|Запись NFC]]
- [[#Создание NFC|Создание NFC]]
- [[#Как работает ИК-порт|Как работает ИК-порт]]
- [[#Как устроен ИК-порт во Flipper Zero|Как устроен ИК-порт во Flipper Zero]]
- [[#Что не так с кондиционерами|Что не так с кондиционерами]]
- [[#Чтение ик|Чтение ик]]
- [[#Универсальный пульт|Универсальный пульт]]
	- [[#Универсальный пульт#TV remote|TV remote]]
	- [[#Универсальный пульт#Audio system remote|Audio system remote]]
	- [[#Универсальный пульт#Projector remote|Projector remote]]
	- [[#Универсальный пульт#Air conditioner remote|Air conditioner remote]]
- [[#Пульты из мобильного приложения|Пульты из мобильного приложения]]
- [[#BLE Spam|BLE Spam]]
	- [[#BLE Spam#SEX TOYS|SEX TOYS]]
- [[#GPIO pinout|GPIO pinout]]
	- [[#GPIO pinout#+3.3 V power (pin 9)|+3.3 V power (pin 9)]]
	- [[#GPIO pinout#+5 V power (pin 1)|+5 V power (pin 1)]]
	- [[#GPIO pinout#Input/output pins|Input/output pins]]
	- [[#GPIO pinout#3.3 V and 5 V tolerance|3.3 V and 5 V tolerance]]
- [[#GPIO menu|GPIO menu]]
- [[#Вскрываем сейф|Вскрываем сейф]]
- [[#Взлом светофоров|Взлом светофоров]]
- [[#W5500|W5500]]
- [[#nrf24l01|nrf24l01]]
- [[#Что такое iButton|Что такое iButton]]
- [[#Режим эмуляции iButton|Режим эмуляции iButton]]
- [[#iButton через внешний GPIO|iButton через внешний GPIO]]
- [[#Формат данных в ключе Dallas|Формат данных в ключе Dallas]]
- [[#Ввод ID вручную|Ввод ID вручную]]
- [[#Запись ключей 1-Wire Dallas|Запись ключей 1-Wire Dallas]]
- [[#Что такое мастер ключ?|Что такое мастер ключ?]]
- [[#Играясь заблокировали домофон?|Играясь заблокировали домофон?]]
- [[#Вездеходы|Вездеходы]]
- [[#Flipper Zero scripting language|Flipper Zero scripting language]]
- [[#Uploading new payloads to Flipper Zero|Uploading new payloads to Flipper Zero]]
- [[#Using your Flipper Zero as a BadUSB device|Using your Flipper Zero as a BadUSB device]]
	- [[#Using your Flipper Zero as a BadUSB device#Via USB connection|Via USB connection]]
	- [[#Using your Flipper Zero as a BadUSB device#Via BLE сonnection|Via BLE сonnection]]
- [[#Setting up your Flipper Zero as a security key|Setting up your Flipper Zero as a security key]]
- [[#Signing in with your Flipper Zero|Signing in with your Flipper Zero]]
- [[#Bluetooth|Bluetooth]]
	- [[#Bluetooth#BLE Spam|BLE Spam]]
	- [[#Bluetooth#BT trigger|BT trigger]]
	- [[#Bluetooth#Anki Remote|Anki Remote]]
	- [[#Bluetooth#BT Remote for kodi|BT Remote for kodi]]
	- [[#Bluetooth#FindMy Flipper|FindMy Flipper]]
	- [[#Bluetooth#Bluetooth Remote|Bluetooth Remote]]
	- [[#Bluetooth#PC Monitor|PC Monitor]]
- [[#Games|Games]]
- [[#GPIO|GPIO]]
	- [[#GPIO#BMI Air Mouse|BMI Air Mouse]]
	- [[#GPIO#[PMSx003] Airmon|[PMSx003] Airmon]]
	- [[#GPIO#AVR Flasher|AVR Flasher]]
		- [[#AVR Flasher#Wiring|Wiring]]
		- [[#AVR Flasher#Supported Microcontrollers|Supported Microcontrollers]]
	- [[#GPIO#BarCode ScannerE|BarCode ScannerE]]
	- [[#GPIO#[ESP32] Camera Suite|[ESP32] Camera Suite]]
	- [[#GPIO#Coffee-EEPROM-FAP|Coffee-EEPROM-FAP]]
	- [[#GPIO#RC2014 ColecoVision|RC2014 ColecoVision]]
	- [[#GPIO#DAP Link|DAP Link]]
	- [[#GPIO#[ESP32] WiFi Marauder|[ESP32] WiFi Marauder]]
	- [[#GPIO#ESP8266 Deauther|ESP8266 Deauther]]
	- [[#GPIO#esp8266_deauther v2|esp8266_deauther v2]]
	- [[#GPIO#IFTTT Virtual Button|IFTTT Virtual Button]]
	- [[#GPIO#ESP Flasher|ESP Flasher]]
	- [[#GPIO#[W5500] Ethernet|[W5500] Ethernet]]
	- [[#GPIO#Evil captive portal|Evil captive portal]]
- [[#Key Copier|Key Copier]]
- [[#Connecting to Flipper Zero|Connecting to Flipper Zero]]
	- [[#Connecting to Flipper Zero#If your Flipper Zero is not detected|If your Flipper Zero is not detected]]
	- [[#Connecting to Flipper Zero#If Flipper Mobile App fails to synchronize with your Flipper Zero|If Flipper Mobile App fails to synchronize with your Flipper Zero]]
- [[#Flipper Mobile App: overview|Flipper Mobile App: overview]]
- [[#Установка|Установка]]
	- [[#Установка#Win|Win]]
	- [[#Установка#Mac|Mac]]
	- [[#Установка#Lin|Lin]]
		- [[#Lin#Используя графический интерфейс пользователя|Используя графический интерфейс пользователя]]
		- [[#Lin#Используя терминал|Используя терминал]]
- [[#Обновление флиппера|Обновление флиппера]]
- [[#Backup|Backup]]
- [[#"Hello world"|"Hello world"]]
	- [[#"Hello world"#Шаг первый: учимся собирать прошивку|Шаг первый: учимся собирать прошивку]]
	- [[#"Hello world"#Шаг второй: пишем приложение|Шаг второй: пишем приложение]]
